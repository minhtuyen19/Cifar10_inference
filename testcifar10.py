...
# input_image = Xtest[104].reshape((32,32,3))       
# l1 = conv2d(input_image, 6, 5, stride = 1, padding = 0).operate()
# l2 = relu(l1).operate()
# l3 = maxpool2(l2,pool_size = 2, stride = 2).operate()
# l4 = conv2d(l3, 16, 5, stride = 1, padding = 0).operate()
# l5 = relu(l4).operate()
# l6 = maxpool2(l5, pool_size = 2, stride = 2).operate()
# l7 = flatten(l6).operate()
# l8 = dense(l7, 120, 120).operate()
# l9 = activation.sigmoid(l8)
# l10 = dense(l9, 84, 84).operate()
# l11 = activation.sigmoid(l10)
# l12 = dense(l11, 10,10).operate()
# l13 = activation.sigmoid(l12)
# 
# 
# 
# model = load_model('modelnew2_cifar10.h5')
# 
# x = model.l13
# 
# print(classes[np.argmax(x)]) #lay vi tri xac suat lon nhat
# plt.imshow(Xtest[104])
# plt.show() 
# =============================================================================
